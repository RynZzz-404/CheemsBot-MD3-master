...
console.log(color('\n🐶 YT CHANNEL: GTW ','silver'))
console.log(color('🐶 GITHUB: RyanStore ','silver'))
console.log(color('🐶 WA NUMBER: +6282252285143 ','silver'))
console.log(color('  YanX Bot Inc. 2022','mediumseagreen'))
    ...
    console.log(color('🐶', 'cyan'), color('https://wa.me/6282252285143'))
    ...
    const XeonBotInc = XeonBotIncConnect({
        ...
        browser: ['YanZBotZ Inc','Safari','1.0.0'],
        auth: state,
        version
    })
